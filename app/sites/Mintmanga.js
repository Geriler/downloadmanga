...
/**
 * Класс для скачивания манги с сайта mintmanga
 */
class Mintmanga extends Site {
    _link = 'https://mintmanga.live/';
    _name_manga = '';
    _num_volume = 1;
    _num_chapter = 0;
    _create_pdf = false;
    ...
    downloadAll() {
        console.log('Download all for Mintmanga');
    }
}

module.exports = Mintmanga;
